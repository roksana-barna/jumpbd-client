        ...
        <div>
            <div className="container  mx-auto mt-8 p-4 bg-gradient-to-r from-blue-400 to-purple-500 min-h-screen py-16">
                ...
                <div className="bg-white p-4 shadow-md rounded-lg">
                        <h2 className="text-xl font-semibold text-cyan-600 mb-2">My Orders</h2>
                    ...
                    {/* <div className="bg-white p-4 shadow-md rounded-lg">
                        ...
                        <Link to="/dashboard/orderdetails" className="text-blue-600 hover:underline block mt-4">
                            View Orders
                        </Link>
                    </div> */}
                    ...
                    <div className="bg-white p-4 shadow-md rounded-lg">
                        ...
                        <Link to="/profile" className="text-blue-600 hover:underline block mt-4">
                            Manage Account
                        </Link>
                    </div>
                    <div className="bg-white p-4 shadow-md rounded-lg">
