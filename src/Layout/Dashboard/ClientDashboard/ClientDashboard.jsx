            ...
            <div className="container  mx-auto mt-8 p-4 bg-gradient-to-r from-blue-400 to-purple-500 min-h-screen py-16">
                ...
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <div className="bg-white p-4 shadow-md rounded-lg">
                        ...
                        <Link to="/dashboard/orders" className="text-blue-600 hover:underline block mt-4">
                            View Orders
                        </Link>
                    </div>
                    ...
                    <div className="bg-white p-4 shadow-md rounded-lg">
                        ...
                        <Link to="/dashboard/orders/:orderId" className="text-blue-600 hover:underline block mt-4">
                            View Order Details
                        </Link>
                    </div>
                    ...
                    <div className="bg-white p-4 shadow-md rounded-lg">
                        ...
                        <Link to="/dashboard/wishlist" className="text-blue-600 hover:underline block mt-4">
                            View Wishlist
                        </Link>
                    </div>
                    ...
                    <div className="bg-white p-4 shadow-md rounded-lg">
                        ...
                        <Link to="/dashboard/ratings" className="text-blue-600 hover:underline block mt-4">
                            Product Reviews
                        </Link>
                    </div>
                    <div className="bg-white p-4 shadow-md rounded-lg">
                        ...
                        <Link to="/dashboard/accountsettings" className="text-blue-600 hover:underline block mt-4">
                            Manage Account
                        </Link>
                    </div>
                    <div className="bg-white p-4 shadow-md rounded-lg">
                        ...
                        <Link to="/dashboard/contactsupport" className="text-blue-600 hover:underline block mt-4">
                            Contact Support
                        </Link>
                    </div>
