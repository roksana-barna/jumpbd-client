...
const Register2 = () => {
    ...
    return (
        ...
        <input type="number" id="subscriptionFee"  name="subscriptionFee" className="shadow appearance-none border rounded w-full py-2 px-3 text-cyan-600 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter subscription Fee" />
      </div>
      <div className="mb-4">
            ...
            <input type="number" id="couponCode"name='couponCode' className="shadow appearance-none border rounded w-full py-2 px-3 text-cyan-600 leading-tight focus:outline-none focus:shadow-outline" placeholder="Enter Coupon No" />
                ...
                <div className='justify-between mt-5 flex gap-3'>
                    ...
                    <Link to='/register3' ><btton className='bg-cyan-700 px-4 py-1 text-white'>Next</btton></Link>
